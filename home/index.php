...
<div class="container align-items-center" id="container">
   <div class="row g-4 text-center ">
       ...
       <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" id="card-content">
        <a href="guidelines.php" class="text-decoration-none">
           <div class="card text-light align-items-center" id="card">
               <div class="card-body text-center">
                   <div class="h1 mb-3">
       ...
       <a href="guidelines.php" class="text-decoration-none text-light">
           <div class="card  text-light align-items-center"id="card">
               <div class="card-body text-center ">
                   <div class="h1 mb-3">
...
<section class="pt-5" id="About">
   <div class="parallax-image">
       <div class="color-overlay d-flex justify-content-center  flex-column  text-center pt-4" style="background-image:url(images/National-Teachers-College.jpg)">
