...
<body>
    ...
    <div class="container-fluid ms-lg-3 me-lg-3">
      ...
      <div class=" collapse navbar-collapse" id="navmenu">
        <ul class="navbar-nav ms-auto navbar">
          ...
          <li class="nav-item ">
            <?php if (isset($_SESSION['authenticated'])) : ?>
              <a href="#" class="nav-link text-dark nav-list">DASHBOARD</a>
            <?php endif ?>
  ...
  <section class="text-light p-4 search-container ">
    <div class="containe ">
      <div class="d-md-flex justify-content-center">
        ...
        <div class="input-group search-bar">
          <input type="text" class="form-control search " placeholder="Search Research Title" aria-label="Search Research" aria-describedby="basic-addon2">
          <div class="input-group-append">
            <button class="btn btn-lg button fw-bold" type="button"><i class="bi bi-search"></i></button>
          </div>
        </div>
