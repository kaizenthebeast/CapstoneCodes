            ...
            <div class="modal-body ">
                ...
                <form action="" method="POST" id="book-form">
                    ...
                    <div class="ticket-container">
                        <div class="title text-white p-2 rounded text-center text-uppercase mb-2" style="background-color: rgb(4, 4, 132);">
                    ...
                    <div class="title text-white p-2 rounded text-center text-uppercase mb-2 mt-4" style="background-color: rgb(4, 4, 132);">
